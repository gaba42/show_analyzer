...
# remove actions from transcript(inside brackets)
...
class CharacterChatBot():
    ...
    def __init__(self,
        ...
        self.base_model_path = "meta-llama/Llama-3.1-8B"
        ...
        if huggingface_hub.repo_exists(self.model_path):
            ...
            print("Model Not Found in huggingface hub. Will train own model")
    ...
    def load_data(self):
        ...
        naruto_transcript_df.loc[(naruto_transcript_df['name']=="Naruto")&(naruto_transcript_df['number_of_words']>5), 'naruto_response_flag']
        ...
        for ind in indexes_to_take:
            ...
            prompt += "Input:" + naruto_transcript_df.iloc[ind -1]['line']
            prompt += '\n'
            prompt += "Naruto response:" + naruto_transcript_df.iloc[ind]['line']
