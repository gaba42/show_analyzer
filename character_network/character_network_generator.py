...
class CharacterNetworkGenerator():
    ...
    def generate_character_network(self, df):
        ...
        for row in df['ners']:  # row = each episode
            ...
            for sentence in row:
                ...
                for entity in sentence:
                    for entity_in_window in previous_entities_flattened:
                        if entity != entity_in_window:  # 두 개의 캐릭터가 동일 캐릭터가 아닐 경우!
    ...
    def draw_network_graph(self, relationship_df):
        relationship_df = relationship_df.sort_values('value', ascending=False)
        # limiting to most import characters
        ...
        display-capture; encrypted-media;" sandbow="allow-modals allow-forms
        allow-cripts allow-same-origin allow-popups
        allow-top-navigation-by-user-activation allow-downloads" allowfullscreen=""
        allowpaymentrequests="" frameborder="0" srcdoc='{html}'></iframe>"""
